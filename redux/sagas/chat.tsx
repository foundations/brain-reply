...
import { messagesRoleType, ChatssetType } from "@/interface/index"
...
function* onGetBrainreply(action: any): any {
  ...
  let chat: any = yield (select as any)(getNewChat, chatIdx)
  ...
  try {
    ...
    let resp = yield call(getChatGPTMsg, payload, { key: chatset.openaiKey })
